...
const RCard = ({ item }) => {
  ...
  return (
    <div
      ...
      className="m-2 bg-white md:max-w-[260px] md:w-[150px] w-[100px] mb-[50px] "
      onClick={() => naviagte(`/product/${item.id}`)}
    >
      <div className="w-full h-[200px] md:max-h-[250px] md:h-[150px]  group relative">
        ...
        <div className="hidden group-hover:block duration-500">
          <div className="w-full h-[200px] md:max-h-[250px] md:h-[400px] h-[200px] group flex md:gap-8 gap-5 justify-center items-center">
            <button
